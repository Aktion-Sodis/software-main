...
class SurveyTag extends Model {
  ...
  factory SurveyTag({String? id, required String text, int? schemeVersion, String? surveyTagsId}) {
  ...
  SurveyTag copyWith({String? id, String? text, int? schemeVersion, String? surveyTagsId}) {
    return SurveyTag._internal(
      id: id ?? this.id,
      text: text ?? this.text,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'text': _text, 'schemeVersion': _schemeVersion, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'surveyTagsId': _surveyTagsId
  };
