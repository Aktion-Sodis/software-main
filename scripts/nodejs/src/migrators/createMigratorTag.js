...
export default async function createOrUpdateTags () {
    ...
    try {
        ...
        var currentSurveyTag; try {const queryResult = await API.graphql({
        ...
        }).catch((e) => {console.log("error in content tag"); console.log(e);});
        ...
        }).catch((e) => {console.log("error in intervention tag"); console.log(e);});
        }
